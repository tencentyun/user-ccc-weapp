...
Component({
  ...
  methods: {
    ...
    requestSigServer: function (userSig, privMapEncrypt) {
      ...
      // 云上环境 https://yun.tim.qq.com/v4/openim/jsonvideoapp
      // 自研环境 https://yun.tim.qq.com/v4/trtc/jsonvideoapp
      var url = this.data.useCloud ? 'https://official.opensso.tencent-cloud.com/v4/openim/jsonvideoapp' : 'https://yun.tim.qq.com/v4/trtc/jsonvideoapp';
      ...
      wx.request({
        ...
        success: function (res) {
          ...
          console.error(pushUrl)  // 必须加上bizbuf
          var bizbuf = {
            Str_uc_params: {
              uc_biz_type: 1000
            }
